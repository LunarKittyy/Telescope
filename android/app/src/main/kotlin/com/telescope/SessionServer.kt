...
// Out-of-band channel: always reachable (unlike MjpegServer). Routes: /v1/ping, /v1/session, /v1/unpair
class SessionServer(
    ...
    enum class Route { Ping, Session, Unpair, NotFound, MethodNotAllowed }

    companion object {
        const val DEFAULT_PORT = 8766

        // Bumped on shape changes. 2: ping carries phoneId/phoneName, /v1/unpair exists.
